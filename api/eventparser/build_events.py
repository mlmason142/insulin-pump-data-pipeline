...
if __name__ == '__main__':
    ...
    merged_events = {}
    events_path = 'api/eventparser/events.json' #fix
    output = f'{header}'
    with open(events_path, "r") as f:
        j = json.loads(f.read())
        merged_events.update(j["events"])

    custom_events_path = 'api/eventparser/custom_events.json' #fix
    with open(custom_events_path, "r") as f:
        j = json.loads(f.read())
        merged_events.update(j["events"])
    ...
    with open(f'{scripts_path}/merged_events.json', 'w') as f:
